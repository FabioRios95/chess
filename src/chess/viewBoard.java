     ...
     game.setBoard(board);
       ...
       int row=0;
        for(int j=y,z=0;j<height;j+=increment,z++){
            ...
            {
                String piece = initializePieces(t,z);
                VBox vbox = new VBox(); //Gives background
                if(row % 2 == 0 && col % 2 == 0)
                {
                    ...
                    vbox.setStyle(
                      ...
                      "-fx-border-color: black;" +
                        "-fx-background-color: #ffffe6");
                }
                else if(row % 2 != 0 && col % 2 != 0)
                {
                    board[t][z] = new Square(i, j, (int)(increment*0.96), (int)(increment*0.96) , t, z, "WHITE", piece, vbox);
                    vbox.setStyle(
                      "-fx-border-style: solid inside;" + 
                      "-fx-border-width: 2;" +
                      "-fx-border-color: black;" +
                ...
                {
                    board[t][z] = new Square(i, j, (int)(increment*0.96), (int)(increment*0.96) , t, z, "BLACK", piece, vbox);
                    //board[t][z].getPiece().setBoard(board);
                    vbox.setStyle(
                      "-fx-border-style: solid inside;" + 
                      "-fx-border-width: 2;" +
                      "-fx-border-color: black;" +
                ...
                vbox.getChildren().add(board[t][z].getRectangle());
